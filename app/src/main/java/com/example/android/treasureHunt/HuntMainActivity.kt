...
class HuntMainActivity : AppCompatActivity() {
    ...
    private val REQUEST_FINE_AND_BACKGROUND_LOCATION_PERMISSION by lazy {
        getString(R.string.request_fine_and_background_location_permission).toInt()
    }
    private val REQUEST_FINE_LOCATION_PERMISSION by lazy {
        getString(R.string.request_fine_location_permission).toInt()
    }
 ...
 */
    ...
    override fun onRequestPermissionsResult(
        ...
        if (grantResults.isEmpty() || PackageManager.PERMISSION_DENIED in grantResults) {
            Snackbar.make(
    ...
    private fun requestForegroundAndBackgroundLocationPermissions() {
        ...
        var requests = arrayOf(Manifest.permission.ACCESS_FINE_LOCATION)
        var requestCode = REQUEST_FINE_LOCATION_PERMISSION
        if (runningQOrLater) {
            requests += Manifest.permission.ACCESS_BACKGROUND_LOCATION
            requestCode = REQUEST_FINE_AND_BACKGROUND_LOCATION_PERMISSION
        }
